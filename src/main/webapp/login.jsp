...
<%--                                    <input id="openMedia" type="button" class="btn btn-success radius size-L" value="开启摄像头" >--%>
                                    <%--<button id="openMedia" class="btn btn-sm btn-default" >开启摄像头</button>
                                    <button id="closeMedia" class="btn btn-sm btn-default" >关闭摄像头</button>
                                    <button id="takePhoto" class="btn btn-sm btn-default" >登录</button>
                                    <button id="takePhoto1" class="btn btn-sm btn-default" >注册</button>--%>
