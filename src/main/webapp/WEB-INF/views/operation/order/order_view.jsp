    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#dataList').datagrid({
                ...
                fit: true,//自动大小
                method: "post",
                url:"get_orderList?t="+new Date().getTime(),
                idField:'yNo',
                ...
                columns: [[
                    ...
                    {field:'yNo',title:'ID',width:80, sortable: true},
                    ...
                    {field:'orderTime',title:'预约时间',width:150, sortable: true},
                    {field:'isBorrow',title:'是否可借',width:150},
                ]],
                toolbar: "#toolbar"
            });
            //设置分页控件
            ...
            $("#editDialog").dialog({
                ...
                onBeforeOpen: function(){
                    ...
                    $("#edit_orderTime").textbox('setValue', selectRow.orderTime);
    ...
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="8">
            ...
            <tr >
                <td>预约时间:</td>
                <td>
                    <input id="add_orderTime"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="orderTime" data-options="required:true, missingMessage:'请填写预约时间'"  />
                </td>
            </tr>
            <tr >
                <td>是否可借:</td>
                <td>
                    <input id="add_isBorrow"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="isBorrow" data-options="required:true, missingMessage:'请填写是否可借'"  />
                </td>
            </tr>
        </table>
    </form>
...
<div id="editDialog" style="padding: 10px">
    <form id="editForm" method="post">
        <input type="hidden" name="yNo" id="edit-id">
        <table id="editTable" border=0 cellpadding="8" >
            ...
            <tr >
                <td>预约时间:</td>
                <td>
                    <input id="edit_orderTime"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="orderTime" data-options="required:true, missingMessage:'请填写预约时间'"  />
                </td>
            </tr>
            <tr >
                <td>是否可借:</td>
                <td>
                    <input id="edit_isBorrow"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="isBorrow" data-options="required:true, missingMessage:'请填写是否可借'"  />
                </td>
            </tr>
        </table>
    </form>
