    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#dataList').datagrid({
                ...
                fit: true,//自动大小
                method: "post",
                url:"get_continueList?t="+new Date().getTime(),
                idField:'ctNo',
                ...
                columns: [[
                    ...
                    {field:'ctNo',title:'ID',width:80, sortable: true},
                    ...
                    {field:'delayTime',title:'续借时间',width:150, sortable: true},
                ]],
                toolbar: "#toolbar"
            });
            //设置分页控件
            ...
            $("#editDialog").dialog({
                ...
                onBeforeOpen: function(){
                    ...
                    $("#edit_delayTime").textbox('setValue', selectRow.delayTime);
                }
            });
    ...
    <form id="addForm" method="post">
        <table id="addTable" cellpadding="8">
            ...
            <tr >
                <td>续借时间:</td>
                <td>
                    <input id="add_delayTime"  class="easyui-textbox" style="width: 200px; height: 30px;" type="int" name="delayTime" data-options="required:true, missingMessage:'请填写续借时间'"  />
                </td>
            </tr>
        </table>
    </form>
...
<div id="editDialog" style="padding: 10px">
    <form id="editForm" method="post">
        <input type="hidden" name="ctNo" id="edit-id">
        <table id="editTable" border=0 cellpadding="8" >
            ...
            <tr >
                <td>续借时间:</td>
                <td>
                    <input id="edit_delayTime"  class="easyui-textbox" style="width: 200px; height: 30px;" type="int" name="delayTime" data-options="required:true, missingMessage:'请填写续借时间'"  />
                </td>
            </tr>
        </table>
    </form>
